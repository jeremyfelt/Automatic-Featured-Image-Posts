...
More settings, including templates for post content, post titles, and custom post types are on their way in the near future.
...
1. If you'd like to change the default post status, configure the plugin using the Auto Image Posts menu under Settings in your admin page. (*See Screenshot*)
